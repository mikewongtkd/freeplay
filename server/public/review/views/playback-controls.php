<section class="playback-toolbar" aria-label="Playback and navigation controls">
  <div class="toolbar-group seek-group btn-group" role="group" aria-label="Seek backward">
  ...
  <div id="scvTools" class="toolbar-group scv-tools d-none btn-group" role="group" aria-label="Single camera fit and zoom">
