    ...
    <div class="scv-video-column">
      <article class="video-tile scv-video">
        <div id="scvScene" class="simulated-video camera-scene camera-scene-1">
          ...
          <button class="camera-nav camera-nav-prev" data-action="previous-camera" aria-label="Previous camera"><i class="bi bi-chevron-left"></i></button>
          <button class="camera-nav camera-nav-next" data-action="next-camera" aria-label="Next camera"><i class="bi bi-chevron-right"></i></button>
          <div class="camera-action"><span class="fighter fighter-hong"></span><span class="fighter fighter-chung"></span></div>
          <div id="scvUnavailable" class="unavailable-overlay"><i class="bi bi-camera-video-off"></i><strong>No video available</strong><span>Choose another camera</span></div>
    ...
    <aside class="scv-side-panel">
      <div class="camera-switcher panel-section">
        ...
        <div class="d-flex gap-2">
          <button class="btn btn-outline-secondary" data-action="previous-camera" aria-label="Previous camera"><i class="bi bi-chevron-left"></i></button>
          <select id="cameraSelect" class="form-select" aria-label="Selected camera"></select>
          <button class="btn btn-outline-secondary" data-action="next-camera" aria-label="Next camera"><i class="bi bi-chevron-right"></i></button>
        </div>
      </div>
