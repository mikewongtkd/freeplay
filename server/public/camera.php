...
<main class="container py-4"><h1 class="h4 mb-3"><?= htmlspecialchars($streamId) ?></h1><div class="card shadow-sm"><div class="card-body"><canvas id="statsChart" height="110"></canvas></div></div></main>
